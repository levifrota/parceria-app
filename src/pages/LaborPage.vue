<template>
  <q-page padding>
    <div class="page-header q-mb-lg">
      ...
      <h1 class="text-h4 text-weight-bold q-ml-md">Parto</h1>
      <q-space />
      <q-btn flat round dense icon="refresh" @click="refreshContents" :loading="loading" />
    </div>

    <div v-if="loading && laborContents.length === 0" class="text-center q-pa-xl">
    ...
    <div v-else class="row q-col-gutter-md">
      <div v-for="content in laborContents" :key="content.id" class="col-12">
        <ContentCard :content="content" />
      </div>

      <div v-if="laborContents.length === 0" class="col-12">
